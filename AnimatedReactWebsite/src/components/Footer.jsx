...
const Footer = () => {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".1" className='w-full h-screen flex gap-5 p-20 bg-zinc-900'>
        <div className='w-1/2 h-full flex flex-col justify-between font-["Founders Grotesk"]'>
      <div className='heading'>
       <h1 className='text-[6vw]  text-white uppercase tracking-tighter leading-none -mb-4 font-semibold'>Eye-</h1>
        <h1 className='text-[6vw]  text-white uppercase tracking-tighter leading-none -mb-4 font-semibold'>Opening</h1></div>
        ...
        '>
        <h1 className='text-[6vw]  text-white uppercase tracking-tighter leading-none -mb-4 font-semibold'>Presentations</h1>
        <div>
          
        </div>
        <div className='flex justify-between items-center'>
        <div className=''>
        <div className='details font-[Neue_Monstreal] mt-16'>
          <h3 className='text-xl transition-all duration-300 hover:underline'>S:</h3>
     <div className='aLink mt-2'>
     {["Facebook", "Instagram", "Twitter", "Behance"].map((item, index) => (
        <a 
          key={index} 
          className='block text-lg -mt-2 tracking-tight transition-all duration-300 hover:underline ' 
          href='#'
        >
          {item}
        </a>
    ...
    <div className='details font-[Neue_Monstreal] mt-16'>
          <h3 className='text-xl transition-all duration-300 hover:underline'>L:</h3>
     <div className='aLink mt-2'>
     {["Facebook", "Instagram", "Twitter", "Behance"].map((item, index) => (
        <a 
          key={index} 
    ...
    <div className='details font-[Neue_Monstreal] mt-8'>
          <h3 className='text-xl transition-all duration-300 hover:underline'>E:</h3>
     <div className='aLink mt-2'>
     {["hello@ochi.design"].map((item, index) => (
        ...
        <div className='details font-[Neue_Monstreal] mt-10'>
          <h3 className='text-xl transition-all duration-300 hover:underline'>S:</h3>
